		...
		<div class="row blog_posts cardPostStyle" style="padding: 0px 16px;">
                                <article>
                                    ...
                                    <div class="post_text">
                                        ...
                                        <h4 class="post_title">
                                            Get involved with: You Are Their Voice
                                            </h4>
										<hr style="margin: 0px;">
                                        <div class="post_content">
											...
											You Are Their Voice is an umbrella organization that supports and creates projects that further help vegan activists with the goal of spreading the vegan lifestyle as far and as wide as possible.
											<br><br>
											<i class="fas fa-angle-double-right"></i>&nbsp;&nbsp;
											In fact, VeganActivism.org is one of You Are Their Voice's very first projects! We're funded by <a href="https://www.patreon.com/youaretheirvoice" style="color:#ff0097;">our Patreon</a> supporters which in turn helps us support vegan activists in need of resources, along with funding us to continue to build more projects like this.
											<br><br>
