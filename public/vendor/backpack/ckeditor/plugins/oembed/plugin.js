    ...
    init: function(editor) {
        ...
        oEmbed: function(url, maxWidth, maxHeight, responsiveResize) {
          ...
          if (typeof jQuery.fn.oembed === 'undefined') {
            CKEDITOR.scriptLoader.load(
              CKEDITOR.getUrl(
                CKEDITOR.plugins.getPath('oembed') +
      ...
      var resizeTypeChanged = function() {
        var dialog = this.getDialog(),
          ...
          maxSizeBox = dialog
            .getContentElement('general', 'maxSizeBox')
            .getElement(),
        ...
        jQuery('body').oembed(url, {
          onEmbed: function(e) {
            ...
            if (align == 'center') {
              ...
              if (!widget.inline) widget.element.removeStyle('text-align')

              if (align == 'none') widget.element.removeStyle('float')
              else widget.element.setStyle('float', align)
            }
      ...
      CKEDITOR.dialog.add('oembed', function(editor) {
        return {
          ...
          onShow: function() {
            ...
            this.getContentElement('general', 'resizeType').setValue(
              data.resizeType,
            )

            this.getContentElement('general', 'align').setValue(data.align)

            var resizetype = this.getContentElement(
                'general',
                'resizeType',
              ).getValue(),
              maxSizeBox = this.getContentElement(
                'general',
                'maxSizeBox',
              ).getElement(),
              sizeBox = this.getContentElement(
                'general',
                'sizeBox',
              ).getElement()
                ...
                },
                {
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      widths: ['120px', '120px'],
                      style:
                        'float:left;position:absolute;left:58%;width:200px',
                      children: [
                        {
                          type: 'text',
                          width: '100px',
                          id: 'maxWidth',
                          default:
                            editor.config.oembed_maxWidth != null
                        ...
                        },
                        {
                          ...
                          width: '120px',
                          default:
                            editor.config.oembed_maxHeight != null
