...
;(function() {
  ...
  var f,
    ...
    z = 'v:arc v:curve v:line v:oval v:polyline v:rect v:roundrect v:group'.split(
      ' ',
    ),
    w = {},
    v = 0
        ...
        return a.sort(
          (function(a) {
            ...
            return function(a, b) {
              ...
              return 0 !== g ? g : c.indexOf(b.selector) - c.indexOf(a.selector)
            }
          })(a),
        )
      },
      ...
      for (a = 0; a < g.length; a++) {
        ...
        for (d = 0; d < h.length; d++) {
          ...
          for (; c < l.length; )
            l.pop(),
              (k = l[l.length - 1]),
              c == l.length && f.setListSymbol(k, b.attributes['cke-symbol'], c)
          b.remove()
          k.add(b)
        }
        l[0].children.length &&
