...
!(function(e, t) {
  ...
  r(l, [], function() {
                ...
                a.domLoaded && 'ready' === b && 'complete' == t.readyState
                  ...
                  : (d ||
                    ...
                    v
                      ? 'ready' === b && a.domLoaded
                        ? p({ type: b })
                        : v.push({ func: p, scope: h })
                      : ((s[g][b] = v = [{ func: p, scope: h }]),
                        (v.fakeName = C),
                        (v.capture = w),
                        (v.nativeHandler = x),
    ...
    var o = 'mce-data-',
      ...
      s = { keyLocation: 1, layerX: 1, layerY: 1, returnValue: 1 }
      ...
      ;(n = window.opera && window.opera.buildNumber),
        ...
        (o =
          ...
          (-1 == t.indexOf('rv:') && -1 == e.appName.indexOf('Netscape'))
            ? !1
            : 11),
        (a = !document.msElementsFromPoint || i || o ? !1 : 12),
        (i = i || o || a),
        (s = !r && !o && /Gecko/.test(t)),
        (l = -1 != t.indexOf('Mac')),
    ...
    r(f, [l, c, d, u], function(e, n, r, i) {
      ...
      var w = document,
        ...
        A = { for: 'htmlFor', class: 'className', readonly: 'readOnly' },
        B = { float: 'cssFloat' },
        D = {},
        M = {},
        H = /^\s*|\s*$/g
    ...
    r(y, [c, f, p, l, h, m, g, u, d, v], function(
      e,
      n,
      r,
      i,
        ...
        (f.prototype = {
          ...
          add: function(e, t, n, r, i) {
            ...
            return this.run(e, function(e) {
              var a
              return (
                (a = h(t, 'string') ? o.doc.createElement(t) : t),
                o.setAttribs(a, n),
          ...
          loadCSS: function(e) {
            var t = this,
              n = t.doc,
              r
            return t !== f.DOM && n === document
              ? void f.DOM.loadCSS(e)
              : (e || (e = ''),
                (r = n.getElementsByTagName('head')[0]),
          ...
          replace: function(e, t, n) {
            ...
            return r.run(t, function(t) {
              return (
                h(t, 'array') && (e = e.cloneNode(!0)),
                n &&
                  p(m(t.childNodes), function(t) {
                    e.appendChild(t)
                  }),
      ...
      function n() {
        ...
        ;(this.isDone = function(e) {
          ...
          (this.add = this.load = function(e, t, r) {
            ...
            i == p && (c.push(e), (l[e] = n)),
              t &&
                (u[e] || (u[e] = []), u[e].push({ func: t, scope: r || this }))
          }),
          ...
          (this.normalize = function(n) {
            function r(r) {
              ...
              function l(n, r) {
                ...
                for (a = new t(r, l); (p = a[n ? 'prev' : 'next']()); ) {
                  ...
                  if (3 === p.nodeType && p.nodeValue.length > 0)
                    return (
                      (c = p), (u = n ? p.nodeValue.length : 0), void (i = !0)
                    )
              ...
              if (
                ...
                (h = e.schema.getNonEmptyElements()),
                (m = r),
                ...
                if (
                  m &&
                  ((p = c.childNodes[u > 0 ? u - 1 : 0]),
                  p && (h[p.nodeName] || 'TABLE' == p.nodeName))
                )
                  return
                if (
                  c.hasChildNodes() &&
          ...
          : ((l = t('id accesskey class dir lang style tabindex title')),
            ...
            'html4' != e &&
              ...
              u.push.apply(
                u,
                t(
                  'audio canvas command datalist mark meter output progress time wbr video ruby bdi keygen',
                ),
              )),
            'html5-strict' != e &&
              (l.push('xml:lang'),
              (p = t('acronym applet basefont big font strike tt')),
              u.push.apply(u, p),
              s(p, function(e) {
                n(e, '', u)
              }),
                    ...
                    if ((s = S.exec(f[i]))) {
                      ...
                      b &&
                        ('=' === b &&
                          ...
                          l.attributesDefault.push({ name: h, value: N }),
                          (c.defaultValue = N)),
                        ':' === b &&
                          ((l.attributesForced = l.attributesForced || []),
                          l.attributesForced.push({ name: h, value: N }),
                          (c.forcedValue = N)),
                        '<' === b && (c.validValues = a(N, '?'))),
                        T.test(h)
        ...
        function m(e) {
          ...
          e &&
            s(t(e, ','), function(e) {
              ...
              r &&
                ((o = r[1]),
                (i = o ? b[r[2]] : (b[r[2]] = { '#comment': {} })),
                (i = b[r[2]]),
                s(t(r[3], '|'), function(e) {
                  '-' === o
                    ? ((b[r[2]] = i = l({}, b[r[2]])), delete i[e])
                    : (i[e] = {})
                }))
            })
        }
      ...
      function i(i, a) {
        ...
        ;(i = i || {}),
          ...
          (l.parse = function(e) {
            ...
            for (
              u < e.length && l.text(z(e.substr(u))), m = p.length - 1;
              m >= 0;
              m--
            )
          ...
          for (
            ...
            if (((r = t[n]), r.parent && !r.fixed))
              if (g[r.name] && 'li' == r.parent.name) {
                ...
                if (o && a.length > 1) {
                  for (
                    a.reverse(), s = c = u.filterNode(a[0].clone()), p = 0;
                    p < a.length - 1;
                    p++
                  ) {
                    for (
                      l.isValidChild(c.name, a[p].name)
                        ? ((d = u.filterNode(a[p].clone())), c.append(d))
                        : (d = c),
                        f = a[p].firstChild;
                      f && f != a[p + 1];
                  ...
                  if ('li' === r.name) {
                    if (
                      ((v = r.prev), v && ('ul' === v.name || 'ul' === v.name))
                    ) {
                      v.append(r)
                      continue
                    }
                    if (
                      ((v = r.next), v && ('ul' === v.name || 'ul' === v.name))
                    ) {
              ...
              for (o.body = 1, n = 0; r > n; n++)
                if (
                  ...
                  for (
                    ...
                    c = c.parent
                  u === c &&
                    ((h = new e('#text', 3)), (h.value = '\xa0'), i.replace(h))
                }
            }),
                ...
                if (
                  ...
                  for (
                    f = [],
                      ...
                      p = 0,
                      h = m.attributesOrder.length;
                    h > p;
                    p++
                  )
                    (u = m.attributesOrder[p]),
                      u in c.map &&
                        ((d = c.map[u]),
                        (f.map[u] = d),
    ...
    r(R, [y, k, g, T, _, E, u, d], function(e, t, n, r, i, o, a, s) {
      ...
      return function(e, i) {
        ...
        return (
          ...
          e.fix_list_elements &&
            f.addNodeFilter('ul,ol', function(e) {
              for (var t = e.length, n, r; t--; )
                (n = e[t]),
                  (r = n.parent),
                  ('ul' === r.name || 'ol' === r.name) &&
          ...
          ),
          {
            ...
            serialize: function(t, n) {
              ...
              return (
                ...
                (h = new r(e, d)),
                (n.content = h.serialize(
                  f.parse(c(n.getInner ? t.innerHTML : s.getOuterHTML(t)), n),
                )),
              ...
              ;(a = i.create('a')),
                ...
                3 == t.nodeType
                  ...
                  : ((h = t.childNodes),
                    h.length
                      ? (n >= h.length
                          ? i.insertAfter(a, h[h.length - 1])
                          : t.insertBefore(a, h[n]),
                        d.moveToElementText(a))
                      : t.canHaveHTML &&
          ...
          ;(n = t.screenX - T),
            ...
            o &&
              (W(n) > W(r)
                ? ((O = V(P * H)), (P = V(O / H)))
                : ((P = V(O / H)), (O = V(P * H)))),
            C.setStyles(_, { width: P, height: O }),
            (a = k.startPos.x + n),
            (s = k.startPos.y + r),
            (a = a > 0 ? a : 0),
            (s = s > 0 ? s : 0),
            C.setStyles(E, { left: a, top: s, display: 'block' }),
            (E.innerHTML = P + ' &times; ' + O),
            k[2] < 0 &&
              _.clientWidth <= P &&
              C.setStyle(_, 'left', A + (D - P)),
            k[3] < 0 &&
              _.clientHeight <= O &&
              C.setStyle(_, 'top', B + (M - O)),
            (n = U.scrollWidth - $),
            (r = U.scrollHeight - q),
            n + r !== 0 && C.setStyles(E, { left: a - n, top: s - r }),
            L ||
              ...
              ? x(N, function(e, i) {
                  function o(t) {
                    ;(T = t.screenX),
                      ...
                      (_.contentEditable = !1),
                      (_.unSelectabe = !0),
                      C.setStyles(_, { left: A, top: B, margin: 0 }),
                      _.removeAttribute('data-mce-selected'),
                      U.appendChild(_),
                      C.bind(I, 'mousemove', a),
                      C.bind(I, 'mouseup', s),
                      F != I &&
                        (C.bind(F, 'mousemove', a), C.bind(F, 'mouseup', s)),
                      (E = C.add(
                        U,
                        'div',
                      ...
                      l
                        ...
                        : ((c = U),
                          (l = C.add(c, 'div', {
                            ...
                            unselectable: !0,
                            style:
                              'cursor:' + i + '-resize; margin:0; padding:0',
                          })),
                          n.ie && (l.contentEditable = !1)),
                      e.elm ||
                        (C.bind(l, 'mousedown', function(e) {
      ...
      function n(n) {
        ...
        ;(this.getBookmark = function(e, i) {
          ...
          if (
            ...
            if (l.item)
              return (
                (p = l.item(0)), (f = p.nodeName), { name: f, index: o(f, p) }
              )
            c = l.duplicate()
            try {
              l.collapse(),
          ...
          (this.moveToBookmark = function(i) {
            ...
            function a(n) {
              ...
              if (
                ...
                ((a = o.parentNode),
                'start' == n
                  ? (h ? ((a = o.firstChild), (s = 1)) : (s = r.nodeIndex(o)),
                    (u = d = a),
                    (f = p = s))
                  : (h ? ((a = o.firstChild), (s = 1)) : (s = r.nodeIndex(o)),
                    (d = a),
    ...
    r(H, [h, A, D, x, M, u, d], function(e, n, r, i, o, a, s) {
      function l(e, t, i, a) {
        var s = this
        ;(s.dom = e),
          (s.win = t),
    ...
    r(O, [h, x, M, L, d, P], function(e, t, n, r, i, o) {
      return function(a) {
        function s(e) {
          return (
        ...
        function h(e, t) {
          e &&
            ('string' != typeof e
              ...
              : ((t = t.length ? t : [t]),
                se(t, function(e) {
                  e.deep === ne && (e.deep = !e.selector),
                    e.split === ne && (e.split = !e.selector || e.inline),
                    e.remove === ne &&
                      e.selector &&
                      !e.inline &&
                      (e.remove = 'none'),
        ...
        function y(t, n, r) {
                ...
                function r(e) {
                  ...
                  return (
                    ...
                    1 === e.nodeType &&
                      ...
                      ((C = p), (p = 'true' === re(e)), (b = !0)),
                    T(g, 'br')
                      ? ((h = 0), void (d.block && $.remove(e)))
                      : d.wrapper && x(e, t, n)
                      ? void (h = 0)
                      : p && !b && d.block && !d.wrapper && s(g) && K(v, l)
                      ? ((e = $.rename(e, l)), i(e), a.push(e), void (h = 0))
                      : d.selector &&
                        (se(c, function(t) {
              ...
              se(a, function(e) {
                ...
                if (d.inline || d.wrapper) {
                  if (
                    ...
                    return $.remove(e, 1), (e = 0), ee
                  d.merge_with_parents &&
                    $.getParent(e.parentNode, function(r) {
                      return x(r, t, n) ? ($.remove(e, 1), (e = 0), ee) : void 0
                    }),
                    e &&
                      d.merge_siblings !== !1 &&
                      ((e = F(I(e), e)), (e = F(e, I(e, ee))))
                }
              })
          }
          var c = p(t),
          ...
          if (d)
            if (r)
              ...
              m &&
              d.inline &&
              !$.select('td.mce-item-selected,th.mce-item-selected').length
            )
              W('apply', t, n)
            else {
        ...
        function b(e, t, n, r) {
          ...
          function o(n) {
            var i
            return (
              se(c(n.parentNode).reverse(), function(n) {
                var o
                i ||
                  '_start' == n.id ||
                  '_end' == n.id ||
                  ((o = x(n, e, t, r)), o && o.split !== !1 && (i = n))
              }),
              i
            )
          }
          ...
          function d(e) {
            ...
            return (
              ae(n) && (n = n[e ? 'firstChild' : 'lastChild']),
              3 == n.nodeType &&
                0 === n.data.length &&
                (n = e
            ...
            : void (q.isCollapsed() &&
              ...
              !$.select('td.mce-item-selected,th.mce-item-selected').length
                ...
                : ((v = q.getBookmark()),
                  f(q.getRng(ee)),
                  q.moveToBookmark(v),
                  m.inline && w(e, t, q.getStart()) && V(q.getRng(!0)),
                  a.nodeChanged()))
        }
        function C(e, t, n) {
          var r = p(e)
          !w(e, t, n) || ('toggle' in r[0] && !r[0].toggle)
            ? y(e, t, n)
            : b(e, t, n)
        }
        function x(e, t, n, r) {
              ...
              if (s.length === ne) {
                for (o in s)
                  if (s.hasOwnProperty(o)) {
                    if (
                      ((a = 'attributes' === i ? $.getAttrib(e, o) : R(e, o)),
                      r && !a && !t.exact)
                    )
                      return
                ...
                for (l = 0; l < s.length; l++)
                  if ('attributes' === i ? $.getAttrib(e, s[l]) : R(e, s[l]))
                    return t
            return t
          }
          var o = p(t),
          ...
          if (o && e)
            for (s = 0; s < o.length; s++)
              if (
                ((a = o[s]),
                S(e, a) && i(e, a, 'attributes') && i(e, a, 'styles'))
              ) {
                if ((l = a.classes))
        ...
        function w(e, t, n) {
          ...
          return n
            ? r(n)
            : ((n = q.getNode()),
              r(n) ? ee : ((i = q.getStart()), i != n && r(i) ? ee : Z))
        }
        function _(e, t) {
          var n,
            r = [],
            ...
            $.getParent(
              ...
              function(n) {
                ...
                for (o = 0; o < e.length; o++)
                  (a = e[o]), !i[a] && x(n, a, t) && ((i[a] = !0), r.push(a))
              },
              $.getRoot(),
            ),
            r
        ...
        function E(e) {
          ...
          if (t)
            for (n = q.getStart(), r = c(n), o = t.length - 1; o >= 0; o--) {
              ...
              for (i = r.length - 1; i >= 0; i--) if ($.is(r[i], a)) return ee
            }
          return Z
        }
        function N(e, t, n) {
        ...
        function A(e, t) {
          return (
            ('color' == t || 'backgroundColor' == t) && (e = $.toHex(e)),
        ...
        function H(t, n, r) {
          function i(e) {
            ...
            if (
              ...
              (s = $.getRoot()),
              3 == r.nodeType && !D(r) && (e ? v > 0 : b < r.nodeValue.length))
            )
              return r
            for (;;) {
              if (!n[0].block_expand && Y(i)) return i
              for (o = i[a]; o; o = o[a]) if (!ae(o) && !D(o) && !t(o)) return i
              if (i.parentNode == s) {
                r = i
                break
              }
          ...
          function u(t, n, i) {
            ...
            for (
              s = new e(t, $.getParent(t, Y) || a.getBody());
              (l = s[i ? 'prev' : 'next']());
          ...
          function f(e, t) {
            var r,
              i = $.getRoot()
            if (
              (n[0].wrapper || (r = $.getParent(e, n[0].block, i)),
              r ||
                (r = $.getParent(3 == e.nodeType ? e.parentNode : e, function(
                  e,
                ) {
                  return e != i && s(e)
                })),
              r && n[0].wrapper && (r = c(r, 'ul,ol').reverse()[0] || r),
              !r)
            )
          ...
          if (
            (1 == g.nodeType &&
              g.hasChildNodes() &&
              ((p = g.childNodes.length - 1),
              (g = g.childNodes[v > p ? p : v]),
              3 == g.nodeType && (v = 0)),
            1 == y.nodeType &&
              y.hasChildNodes() &&
              ((p = y.childNodes.length - 1),
              (y = y.childNodes[b > p ? p : b - 1]),
              3 == y.nodeType && (b = y.nodeValue.length)),
            (g = l(g)),
            (y = l(y)),
            (ae(g.parentNode) || ae(g)) &&
              ((g = ae(g) ? g : g.parentNode),
              (g = g.nextSibling || g),
              3 == g.nodeType && (v = 0)),
            (ae(y.parentNode) || ae(y)) &&
              ((y = ae(y) ? y : y.parentNode),
            ...
            h.node &&
              h.offset > 0 &&
              3 === h.node.nodeType &&
              ' ' === h.node.nodeValue.charAt(h.offset - 1) &&
              h.offset > 1 &&
          ...
          return (
            ...
            (n[0].block || n[0].selector) &&
              ...
              (y = f(y, 'nextSibling')),
              n[0].block && (Y(g) || (g = i(!0)), Y(y) || (y = i()))),
            1 == g.nodeType && ((v = X(g)), (g = g.parentNode)),
            1 == y.nodeType && ((b = X(y) + 1), (y = y.parentNode)),
        ...
        function P(e, t, n, r) {
          var i, o, a
          if (!S(n, e) && !L(n, e)) return Z
          if ('all' != e.remove)
            for (
              se(e.styles, function(i, o) {
                ;(i = A(B(i, t), o)),
                  'number' == typeof o && ((o = i), (r = 0)),
                  (e.remove_similar || !r || T(R(r, o), i)) &&
                    $.setStyle(n, o, ''),
                  (a = 1)
              }),
                a &&
                ...
                se(e.attributes, function(e, i) {
                  ...
                  if (
                    ...
                    if (
                      ...
                      e &&
                        ((o = ''),
                        se(e.split(/\s+/), function(e) {
                          ;/mce\-\w+/.test(e) && (o += (o ? ' ' : '') + e)
                        }),
                        o))
                    )
                      return void $.setAttrib(n, i, o)
                    'class' == i && n.removeAttribute('className'),
                      Q.test(i) && n.removeAttribute('data-mce-' + i),
                      n.removeAttribute(i)
                  }
                }),
                se(e.classes, function(e) {
                  ;(e = B(e, t)),
                    (!r || $.hasClass(r, e)) && $.removeClass(n, e)
                }),
                o = $.getAttribs(n),
                i = 0;
              i < o.length;
        ...
        function O(e, t) {
          ...
          t.block &&
            (G
              ? r == $.getRoot() &&
                ((t.list_block && T(e, t.list_block)) ||
                  se(le(e.childNodes), function(e) {
                    K(G, e.nodeName.toLowerCase())
                      ? i
                        ? i.appendChild(e)
                        : ((i = M(e, G)),
                          $.setAttribs(i, a.settings.forced_root_block_attrs))
                      : (i = 0)
                  }))
              : Y(e) &&
                !Y(r) &&
                (n(e, Z) ||
                  n(e.firstChild, ee, 1) ||
                  e.insertBefore($.create('br'), e.firstChild),
                n(e, ee) ||
                  n(e.lastChild, Z, 1) ||
                  e.appendChild($.create('br')))),
            (t.selector && t.inline && !T(t.inline, e)) || $.remove(e, 1)
        }
        function I(e, t, n) {
          if (e)
            for (
        ...
        function W(t, n, r, i) {
                ...
                ce(
                  ...
                  function(e) {
                    1 != e.nodeType ||
                      e.id === g ||
                      $.isEmpty(e) ||
                      $.setAttrib(e, 'data-mce-bogus', null)
                  },
                  'childNodes',
                )
          }
          ...
          a._hasCaretEvents ||
            ((oe = function() {
              ...
              if (l(c(q.getStart()), e))
                for (t = e.length; t--; )
                  $.setAttrib(e[t], 'data-mce-bogus', '1')
            }),
            (ie = function(e) {
              var t = e.keyCode
              d(),
                ((8 == t && q.isCollapsed()) || 37 == t || 39 == t) &&
                  d(c(q.getStart())),
                m()
            }),
        ...
        function V(t) {
          ...
          if (
            (3 == n.nodeType &&
              r >= n.nodeValue.length &&
              ((r = X(n)), (n = n.parentNode), (i = !0)),
            1 == n.nodeType)
          )
            for (
              s = n.childNodes,
                n = s[Math.min(r, s.length - 1)],
                o = new e(n, $.getParent(n, $.isBlock)),
              ...
              if (3 == a.nodeType && !D(a))
                return (
                  (l = $.create('a', { 'data-mce-bogus': 'all' }, J)),
            ...
            (l = {
              ...
              add: function(t, r) {
                var i,
                  o = e.settings,
                  s
                if (((t = t || {}), (t.content = n()), p || e.removed))
                  return null
                if (
                  ((s = u[c]),
                  e
      ...
      return function(i) {
        function o(o) {
          ...
          function b(t) {
            ...
            if (
              'TABLE' === R.nodeName ||
              (R.previousSibling && 'TABLE' == R.previousSibling.nodeName)
            )
              return (z && !t) || (!z && t)
            for (
              n = new e(R, B),
          ...
          function x() {
            function e(e) {
              for (
                var t = P[e ? 'firstChild' : 'lastChild'];
                t && 1 != t.nodeType;
            ...
            ;/^(OL|UL|LI)$/.test(n) && (F = 'LI'),
              ...
              e(!0) && e()
                ...
                ? 'LI' == n
                  ? (a.insertAfter(H, t()),
                    H.appendChild(a.doc.createTextNode(' ')),
                    H.appendChild(P))
                  : P.parentNode.insertBefore(H, P)
                : e()
                ? (a.insertAfter(H, t()), h(H))
                : ((P = t()),
                  (S = k.cloneRange()),
                  S.setStartAfter(B),
                  S.setEndAfter(P),
                  (L = S.extractContents()),
                  'LI' == F && 'LI' == L.firstChild.nodeName
                    ? ((H = L.firstChild), a.insertAfter(L, P))
                    : (a.insertAfter(L, P), a.insertAfter(H, P))),
              a.remove(B),
              g(H),
              c.add()
          }
          ...
          var k, S, T, R, A, B, D, M, H, L, P, O, I, F, z
          if (((k = s.getRng(!0)), !o.isDefaultPrevented())) {
            ...
            if (
              ...
              (R = k.startContainer),
              (A = k.startOffset),
              (F = (l.force_p_newlines ? 'p' : '') || l.forced_root_block),
              (F = F ? F.toUpperCase() : ''),
              (D = a.doc.documentMode),
              (M = o.shiftKey),
              1 == R.nodeType &&
                R.hasChildNodes() &&
                ((z = A > R.childNodes.length - 1),
                (R = R.childNodes[Math.min(A, R.childNodes.length - 1)] || R),
                (A = z && 3 == R.nodeType ? R.nodeValue.length : 0)),
              (T = E(R)))
            ) {
              ...
              if (
                (((F && !M) || (!F && M)) && (R = C(R, A)),
                (B = a.getParent(R, a.isBlock)),
                (P = B ? a.getParent(B.parentNode, a.isBlock) : null),
                (O = B ? B.nodeName.toUpperCase() : ''),
                (I = P ? P.nodeName.toUpperCase() : ''),
                'LI' != I || o.ctrlKey || ((B = P), (O = I)),
                /^(LI|DT|DD)$/.test(O))
              ) {
                if (!F && M) return void w()
                if (a.isEmpty(B)) return void x()
              }
              if ('PRE' == O && l.br_in_pre !== !1) {
                if (!M) return void w()
              } else if ((!F && !M && 'LI' != O) || (F && M)) return void w()
              ;(F && B === i.getBody()) ||
                ((F = F || 'P'),
                b()
                  ? ((H =
                      /^(H[1-6]|PRE|FIGURE)$/.test(O) && 'HGROUP' != I
                        ? y(F)
                        : y()),
                    l.end_container_on_empty_block && p(P) && a.isEmpty(B)
                      ? (H = a.split(P, B))
                      : a.insertAfter(H, B),
                    g(H))
                  : b(!0)
                  ? ((H = B.parentNode.insertBefore(y(), B)), h(H), g(B))
                  : ((S = k.cloneRange()),
                    S.setEndAfter(B),
                    (L = S.extractContents()),
                    _(L),
          ...
          if (((C = n.forced_root_block), t && 1 === t.nodeType && C)) {
            ...
            for (t = s.firstChild, b = s.nodeName.toLowerCase(); t; )
              if (
                ...
                p ||
                  ((p = r.create(C, e.settings.forced_root_block_attrs)),
        ...
        r.on('PreInit', function() {
          ...
          C({
            ...
            mceInsertContent: function(t, n, o) {
              ...
              function c(e) {
                if (_)
                  for (C = e.firstChild; C; C = C.walk(!0))
                    E[C.name] && C.attr('data-mce-new', 'true')
              }
              function u() {
                if (_) {
                  var e = r.getBody(),
              ...
              var d,
                ...
                w,
                _,
                E = r.schema.getTextInlineElements()
              'string' != typeof o && ((_ = o.merge), (o = o.content)),
                /^ | $/.test(o) && (o = a(o)),
                (d = r.parser),
                (f = new e({}, r.schema)),
                (w =
              ...
              if (
                ...
                c(g),
                (C = g.lastChild),
                'mce_marker' == C.attr('id'))
              )
                for (y = C, C = C.prev; C; C = C.walk(!0))
                  if (3 == C.type || !B.isBlock(C.name)) {
                    r.schema.isValidChild(C.parent.name, 'span') &&
                      C.parent.insert(y, C, 'br' === C.name)
                    break
                  }
              if (S.invalid) {
                for (
                  D.setContent(w),
                    h = D.getNode(),
                    m = r.getBody(),
                    9 == h.nodeType ? (h = C = m) : (C = h);
                  C !== m;

                )
                  (h = C), (C = C.parentNode)
                ;(o = h == m ? m.innerHTML : B.getOuterHTML(h)),
                  (o = f.serialize(
                    d.parse(
                      o.replace(
              ...
              u(),
                ...
                (C = y.previousSibling),
                C && 3 == C.nodeType
                  ? (b.setStart(C, C.nodeValue.length),
                    p ||
                      ((x = y.nextSibling),
                      x &&
                        3 == x.nodeType &&
            ...
            InsertLineBreak: function(e, t, n) {
              function i() {
                for (
                  var e = new a(p, v), t, n = r.schema.getNonEmptyElements();
                  (t = e.next());
    ...
    r(j, [d, q, U], function(e, t, n) {
      ...
      return (
        ...
        e.each(
          'fire on off show hide addClass removeClass append prepend before after reflow'.split(
            ' ',
          ),
          function(t) {
            i[t] = function() {
        ...
        c = e.extend({
          ...
          init: function(e) {
            ...
            ;(n._classes = r || []),
              n.visible(!0),
              t.each(
                'title text width height name classes visible disabled active value'.split(
                  ' ',
                ),
                function(t) {
                  var r = e[t],
          ...
          Properties:
            'parent,title,text,width,height,disabled,active,name,value',
          Methods: 'renderHtml',
          ...
          addClass: function(e, t) {
            ...
            return (
              ...
              r || ((r = []), (r.map = {}), (n._classes[t || 'control'] = r)),
              r.map[e] ||
                ((r.map[e] = e),
                r.push(e),
                n._rendered &&
                  ((i = n.getEl(t)), i && (i.className = r.join(' ')))),
              n
            )
          },
          removeClass: function(e, t) {
            ...
            return (
              n._rendered &&
                ((o = n.getEl(t)), o && (o.className = r.join(' '))),
              n
            )
          },
          ...
          getEl: function(e) {
            ...
            return (
              this._elmCache[t] || (this._elmCache[t] = i.get(t)),
              this._elmCache[t]
            )
          },
          visible: function(e) {
            ...
            return 'undefined' != typeof e
              ? (t._visible !== e &&
                  (t._rendered && (t.getEl().style.display = e ? '' : 'none'),
                  (t._visible = e),
                  (n = t.parent()),
                  n && (n._lastRect = null),
                  t.fire(e ? 'show' : 'hide')),
          ...
          renderBefore: function(e) {
            var t = this
            return (
              e.parentNode.insertBefore(i.createFragment(t.renderHtml()), e),
              t.postRender(),
              t
            )
          },
          ...
          bindPendingEvents: function() {
            ...
            if (((o._rendered = !0), (f = o._nativeEvents))) {
              for (
                u = o.parents().toArray(), u.unshift(o), l = 0, c = u.length;
                !d && c > l;
                l++
              )
                d = u[l]._eventsRoot
              ...
              for (p in f) {
                ...
                'wheel' !== p || s
                  ? ('mouseenter' === p || 'mouseleave' === p
                      ? d._hasMouseEnter ||
                        (i.on(d.getEl(), 'mouseleave', t),
                        i.on(d.getEl(), 'mouseover', n),
                        (d._hasMouseEnter = 1))
                      : h[p] || (i.on(d.getEl(), p, e), (h[p] = !0)),
                    (f[p] = !1))
                  : a
            ...
            function t(t, a, s, l, c, u) {
              ...
              if ((f = i.getEl('scroll' + t))) {
                if (
                  ...
                  (b = s.toLowerCase()),
                  i.getEl('absend') &&
                    e.css(i.getEl('absend'), y, i.layoutRect()[l] - 1),
                  !c)
                )
    ...
    r(re, [ee, te, ne, K], function(e, t, n, r) {
            ...
            if (2 != t.button)
              for (var n = p.length; n--; ) {
                ...
                if (r.settings.autohide) {
                  ...
                  ;(t = r.fire('autohide', { target: t.target })),
        ...
        if (!f) {
          ...
          ;(f = function() {
            ;(document.all && t == e.clientWidth && n == e.clientHeight) ||
              ((t = e.clientWidth), (n = e.clientHeight), g.hideAll())
          }),
      ...
      function l(e, t) {
        ...
        o
          ? r.css(a, 'z-index', o.zIndex - 1)
          : a && (a.parentNode.removeChild(a), (m = !1)),
          (g.currentZIndex = i)
      }
      function c(e) {
        var t
      ...
      var u,
        ...
        g = e.extend({
              ...
              t.on('postrender show', function(e) {
                if (e.control == t) {
                  ...
                  t.modal &&
                    ...
                    (n = n.firstChild),
                    t.getContainerElm().appendChild(n),
                    setTimeout(function() {
          ...
          close: function() {
            var e = this
            return (
              e.fire('close').isDefaultPrevented() || (e.remove(), l(!1, e)), e
            )
          },
          remove: function() {
            c(this), this._super()
        ...
        fullscreen: function(e) {
          ...
          if (e != t._fullscreen)
            if (
              ...
              ;(t._initial = { x: a.x, y: a.y, w: a.w, h: a.h }),
      ...
      return function(s) {
        ...
        function d(e) {
          ...
          e.dataTransfer &&
            ...
            t.length > 0 && e.dataTransfer.setData(ae, oe + escape(t)))
        }
        function f(e) {
          var t, n
          return (
            e.dataTransfer &&
              ((t = e.dataTransfer.getData(ae)),
              t && t.indexOf(oe) >= 0 && (n = unescape(t.substr(oe.length)))),
            n
          )
        }
        function p(e) {
        ...
        function h() {
          ...
          function i(e, t) {
            ...
            for (n = e.nextSibling; n && n != t; n = n.nextSibling)
              if ((3 != n.nodeType || 0 !== Y.trim(n.data).length) && n !== t)
                return !1
            return n === t
          }
          function o(e, t, i) {
          ...
          function l(e) {
            ...
            if (
              ...
              return (
                ...
                (i = o(n, !1)),
                (a = o(r, !0)),
                v.isEmpty(r) || Y(n).append(r.childNodes),
                Y(r).remove(),
                i
                  ? 1 == i.nodeType
                    ? 'BR' == i.nodeName
        ...
        function m() {
          function e(e) {
            var t = J.create('body'),
              n = e.cloneContents()
            return (
              t.appendChild(n), Q.serializer.serialize(t, { format: 'html' })
            )
          }
          function n(n) {
            if (!n.setStart) {
          ...
          s.on('keydown', function(e) {
            ...
            if (!u(e) && (t == X || t == G)) {
              ...
              e.preventDefault(),
                s.setContent(''),
                i.firstChild && J.isBlock(i.firstChild)
        ...
        function v() {
          s.settings.content_editable ||
            (J.bind(s.getDoc(), 'focusin', function() {
              Q.setRng(Q.getRng())
            }),
            ...
            if (!u(e) && e.keyCode === G) {
              ...
              if (Q.isCollapsed() && 0 === Q.getRng(!0).startOffset) {
                var t = Q.getNode(),
                  n = t.previousSibling
                if ('HR' == t.nodeName)
                  return J.remove(t), void e.preventDefault()
                n &&
                  n.nodeName &&
                  'hr' === n.nodeName.toLowerCase() &&
                  (J.remove(n), e.preventDefault())
              }
            }
          })
        }
        ...
        function C() {
          s.on('click', function(e) {
            ...
            ;/^(IMG|HR)$/.test(t.nodeName) &&
              (e.preventDefault(),
              Q.getSel().setBaseAndExtent(t, 0, t, 1),
              s.nodeChanged()),
              'A' == t.nodeName &&
                J.hasClass(t, 'mce-item-anchor') &&
        ...
        function x() {
          ...
          function t() {
            return (
              !Q.isCollapsed() &&
              J.getParent(Q.getStart(), J.isBlock) !=
                J.getParent(Q.getEnd(), J.isBlock)
            )
          }
        ...
        function E() {
          c() > 7 ||
            ...
            J.addClass(s.getBody(), 'mceHideBrInPre'),
        ...
        function N() {
          J.bind(s.getBody(), 'mouseup', function() {
            var e,
              t = Q.getNode()
            'IMG' == t.nodeName &&
              ((e = J.getStyle(t, 'width')) &&
                (J.setAttrib(t, 'width', e.replace(/[^0-9%]+/g, '')),
                J.setStyle(t, 'width', '')),
              (e = J.getStyle(t, 'height')) &&
                (J.setAttrib(t, 'height', e.replace(/[^0-9%]+/g, '')),
                J.setStyle(t, 'height', '')))
          })
        }
        function k() {
        ...
        function S() {
          function e() {
            s._refreshContentEditable(),
              ...
              Z.object_resizing || l('enableObjectResizing', !1)
          }
        ...
        function D() {
          ...
          c() >= 10 &&
            ((e = ''),
            K('p div h1 h2 h3 h4 h5 h6'.split(' '), function(t, n) {
              e += (n > 0 ? ',' : '') + t + ':empty'
            }),
        ...
        function H() {
          ...
          ;(r.documentElement.unselectable = !0),
            J.bind(r, 'mousedown contextmenu', function(i) {
              ...
              !i ||
                ...
                s.once('touchend', function(e) {
                  ...
                  new Date().getTime() - n > 500 ||
                    ...
                    (o = s.fire('click', o)),
                    o.isDefaultPrevented() ||
                      (s.selection.placeCaretAt(i.clientX, i.clientY),
                      s.nodeChanged()))
                }))
          })
        }
        ...
        k(),
          ...
          ie &&
            ...
            U(),
            o.iOS ? (O(), I(), V()) : g()),
          re && o.ie < 11 && (y(), w(), E(), N(), B(), D(), M(), H()),
          o.ie >= 11 && (I(), W(), _()),
          o.ie && (g(), z(), j()),
          ne && (y(), b(), x(), S(), T(), A(), P(), F(), _())
      }
    }),
    r(le, [$], function(e) {
      function t(t) {
      ...
      function(
        ...
        function N(e, t, i) {
          ...
          ;(a = o.documentBaseUrl = i.documentBaseURL),
            ...
            (o.shortcuts = new E(o)),
            (o.loadedCSS = {}),
            (o.editorCommands = new p(o)),
            t.target && (o.targetElm = t.target),
            (o.suffix = i.suffix),
            (o.editorManager = i),
            (o.inline = t.inline),
            t.cache_suffix &&
              (x.cacheSuffix = t.cache_suffix.replace(/^[\?\&]+/, '')),
          ...
          (N.prototype = {
            render: function() {
              ...
              function t() {
                ...
                w.isArray(r.plugins) && (r.plugins = r.plugins.join(' ')),
                  A(r.external_plugins, function(e, t) {
              ...
              var n = this,
                ...
                i = n.id,
                o = n.suffix
              if (!L.domLoaded) return void k.bind(window, 'ready', e)
            ...
            init: function() {
              ...
              if (
                ...
                (t.rtl = this.editorManager.i18n.rtl),
            ...
            initContentBody: function(t) {
              ...
              r.inline || (n.getElement().style.visibility = n.orgVisibility),
                t ||
                  r.content_editable ||
                  (p.open(), p.write(n.iframeHTML), p.close()),
                r.content_editable &&
                  (n.on('remove', function() {
                    var e = this.getBody()
                ...
                r.readonly ||
                  (n.inline &&
                    'static' == k.getStyle(h, 'position', !0) &&
                    (h.style.position = 'relative'),
                  (h.contentEditable = n.getParam(
                ...
                n.parser.addAttributeFilter('src,href,style,tabindex', function(
                  e,
                  t,
                ) {
                ...
                r.browser_spellcheck ||
                  r.gecko_spellcheck ||
                  ((p.body.spellcheck = !1),
                  k.setAttrib(h, 'spellcheck', 'false')),
                n.fire('PostRender'),
                (n.quirks = new C(n)),
                r.directionality && (h.dir = r.directionality),
                r.nowrap && (h.style.whiteSpace = 'nowrap'),
                r.protect &&
                ...
                n.contentStyles.length > 0 &&
                  ((m = ''),
                  A(n.contentStyles, function(e) {
                    m += e + '\r\n'
                  }),
                  n.dom.addStyle(m)),
                A(n.contentCSS, function(e) {
            ...
            focus: function(e) {
              ...
              if (!e) {
                if (
                  ...
                  r || (x.opera || t.getBody().focus(), t.getWin().focus()),
                  P || r)
                ) {
            ...
            hide: function() {
              var e = this,
                t = e.getDoc()
              e.hidden ||
                (O && t && !e.inline && t.execCommand('SelectAll'),
                e.save(),
                e.inline
                ...
                0 === e.length || /^\s+$/.test(e)
                  ? ((i = n.settings.forced_root_block),
                    ...
                    n.schema.isValidChild(
                      ...
                      ? ((e = O && 11 > O ? '' : '<br data-mce-bogus="1">'),
                        (e = n.dom.createHTML(
                          i,
                          n.settings.forced_root_block_attrs,
                          e,
                        )))
                      : O || (e = '<br data-mce-bogus="1">'),
                    n.dom.setHTML(r, e),
                    n.fire('SetContent', t))
                  : ('raw' !== t.format &&
            ...
            addVisual: function(e) {
              ...
              ;(e = e || n.getBody()),
                ...
                A(i.select('table,a', e), function(e) {
                  var t
                  switch (e.nodeName) {
                    case 'TABLE':
                      return (
            ...
            remove: function() {
              ...
              e.removed ||
                ...
                e.inline ||
                  (O && 10 > O && e.getDoc().execCommand('SelectAll', !1, null),
                  k.setStyle(e.id, 'display', e.orgDisplay),
                  (e.getBody().onload = null)),
                e.fire('remove'),
    ...
    r(he, [de, f, y, V, u, d, le, fe, pe], function(e, t, n, r, i, o, a, s, l) {
      function c(e) {
        ...
        return (
          v.activeEditor == e && (v.activeEditor = t[0]),
      ...
      function u(e) {
        return (
          e &&
            ...
            (c(e), e.unbindAllNativeEvents(), e.destroy(!0), (e = null)),
          e
        )
      }
      var d = n.DOM,
              ...
              i
            {
              if (e)
                return 'string' == typeof e
                  ...
                  : ((i = e),
                    r[i.id]
                      ? (c(i) && t.fire('RemoveEditor', { editor: i }),
        ...
        send: function(e) {
          function t() {
            !e.async || 4 == r.readyState || i++ > 1e4
              ? (e.success && 1e4 > i && 200 == r.status
                  ? e.success.call(e.success_scope, '' + r.responseText, r, e)
                  : e.error &&
                    e.error.call(
                      e.error_scope,
                      i > 1e4 ? 'TIMED_OUT' : 'GENERAL',
                      r,
                      e,
                    ),
                (r = null))
          ...
          if (
            ...
            if (
              (r.overrideMimeType && r.overrideMimeType(e.content_type),
              r.open(e.type || (e.data ? 'POST' : 'GET'), e.url, e.async),
              e.crossDomain && (r.withCredentials = !0),
              e.content_type &&
                r.setRequestHeader('Content-Type', e.content_type),
              r.setRequestHeader('X-Requested-With', 'XMLHttpRequest'),
              (r = n.fire('beforeSend', { xhr: r, settings: e }).xhr),
              r.send(e.data),
              !e.async)
            )
              return t()
        ...
        r = e.extend({
          ...
          active: function(e) {
            var t = this,
              n
            return (
              e !== n && (t.aria('pressed', e), t.toggleClass('active', e)),
              t._super(e)
            )
          },
          disabled: function(e) {
            var t = this,
              n
            return (
              e !== n && (t.aria('disabled', e), t.toggleClass('disabled', e)),
              t._super(e)
            )
          },
          postRender: function() {
    ...
    r(Te, [Ne], function(e) {
      return e.extend({
        ...
        checked: function(e) {
          var t = this
          return 'undefined' != typeof e
            ? (e ? t.addClass('checked') : t.removeClass('checked'),
              (t._checked = e),
              t.aria('checked', e),
              t)
            : t._checked
            ...
            e.placeholder &&
              ...
              t.on('focusin', function() {
                t._hasOnChange ||
                  ...
                  (t._hasOnChange = !0)),
                  t.hasClass('placeholder') &&
                    ((t.getEl('inp').value = ''), t.removeClass('placeholder'))
              }),
        ...
        repaint: function() {
          ...
          return (
            s.all &&
              ...
              (a = e.layoutRect().h - 2 + 'px'),
            n.css(t.firstChild, { width: o, lineHeight: a }),
            e._super(),
            e
          )
        },
    ...
    r(Ae, [Re], function(e) {
      return e.extend({
        ...
        value: function(e) {
          var t = this
          return (
            'undefined' != typeof e && t._rendered && t.repaintColor(e),
            t._super(e)
          )
        },
      })
    ...
    r(He, [Ne, Q, K, Me], function(e, t, n, r) {
      return e.extend({
        ...
        postRender: function() {
          ...
          function i(e, t) {
            var i = (360 - e.h) / 360
            n.css(d, { top: 100 * i + '%' }),
              t || n.css(p, { left: e.s + '%', top: 100 - e.v + '%' }),
          ...
          e.delimiter || (e.delimiter = '\xbb'),
            ...
            t.on('click', function(e) {
              ...
              ;(n = r.getAttribute('data-index')) &&
                t.fire('select', { value: t.data()[n], index: n })
            })
        },
        focus: function() {
          var e = this
    ...
    r(Ve, [_e], function(e) {
      return e.extend({
        recalc: function(e) {
          ...
          if (
            ((x = {}),
            0 > d ? (x[N] = i[N] - d + i[A]) : (x[N] = i[R] - d + i[A]),
            (x[L] = _ + i[I]),
            (x[B] = i[R] - d),
            (x[F] = _),
            ...
            for (
              ...
              (p = r[t]),
                ...
                (y = h.maxFlexSize || h[N]),
                'center' === s
                  ? (x[D] = Math.round(i[M] / 2 - h[H] / 2))
                  : 'stretch' === s
                  ? ((x[H] = z(h[L] || 0, i[M] - o[P] - o[O])), (x[D] = o[P]))
                  : 'end' === s && (x[D] = i[M] - h[H] - o.top),
                h.flex > 0 && (y += h.flex * C),
                (x[E] = y),
                (x[k] = w),
                p.layoutRect(x),
        ...
        initLayoutRect: function() {
          ...
          if (e.settings.multiline) {
            ...
            r.width > n.maxW && ((n.minW = n.maxW), e.addClass('multiline')),
              ...
              (n.startMinH = n.h = n.minH = Math.min(
                n.maxH,
                t.getSize(e.getEl()).height,
              ))
          }
          return n
        },
    ...
    r(Xe, [ke, G, Ge], function(e, t, n) {
      ...
      var i = e.extend({
        ...
        text: function(e) {
          ...
          if (t._rendered)
            for (
              r = t.getEl('open').getElementsByTagName('span'), n = 0;
              n < r.length;
              n++
            )
              r[n].innerHTML =
      ...
      return e.extend({
        init: function(e) {
          ...
          ;(n._values = r = e.values),
            r &&
              (t(r),
              !i && r.length > 0 && ((o = r[0].text), (n._value = r[0].value)),
              (e.menu = r)),
            ...
            n.on('select', function(t) {
              ...
              a && (t.lastControl = a),
                e.multiple
                  ? r.active(!r.active())
                  : n.value(t.control.settings.value),
                (a = r)
            })
        },
        value: function(e) {
          ...
          return (
            'undefined' != typeof e &&
              (r.menu ? t(r.menu, e) : ((a = r.settings.menu), n(a)),
      ...
      return e.extend({
        ...
        renderHtml: function() {
          ...
          var t = this,
            ...
            c = i.shortcut
          return (
            s && t.parent().addClass('menu-has-icons'),
            i.image &&
              ((s = 'none'),
      ...
      return e.extend({
        ...
        repaint: function() {
          ...
          return (
            ...
            (i = n.firstChild),
            (o = n.lastChild),
            t.css(i, { width: r.w - t.getSize(o).width, height: r.h - 2 }),
            t.css(o, { height: r.h - 2 }),
            e
          )
        },
        activeMenu: function(e) {
    ...
    r(at, [Ne, K], function(e, t) {
      return e.extend({
                  ...
                  13 == e.keyCode &&
                    t
                      ...
                      .each(function(t) {
                        return (
                          e.preventDefault(),
                          t.hasEventListeners('submit') && t.toJSON
        ...
        disabled: function(e) {
          var t = this
          return (
            t._rendered && 'undefined' != typeof e && (t.getEl().disabled = e),
            t._super(e)
          )
        },
        value: function(e) {
