!(function(a, b) {
  ...
  d(
      ...
      return function(f, g) {
        function h() {
          ...
          ;(F = []),
            ...
            e(['thead', 'tbody', 'tfoot'], function(b) {
              ...
              e(c, function(c, f) {
                ;(f += a),
                  e(L.select('> td, > th', c), function(a, c) {
                    var e, g, h, i
                    if (F[f]) for (; F[f][c]; ) c++
                    for (
                      h = d(a, 'rowspan'), i = d(a, 'colspan'), g = f;
                      f + h > g;
                      g++
                    )
                      for (F[g] || (F[g] = []), e = c; c + i > e; e++)
                        F[g][e] = {
                          part: b,
                          real: g == f && e == c,
                          elm: a,
          ...
          return (
            e(g.rows, function(b) {
              e(b.cells, function(c) {
                return L.hasClass(c, 'mce-item-selected') || (J && c == J.elm)
                  ? (a.push(b), !1)
                  : void 0
              })
            }),
        ...
        function o(b) {
          var d,
            g = {}
          return (
            f.settings.table_clone_elements !== !1 &&
              (g = a.makeMap(
                (
                  f.settings.table_clone_elements ||
            ...
            a.walk(
              ...
              function(a) {
                var f
                return 3 == a.nodeType
                  ? (e(L.getParents(a.parentNode, null, b).reverse(), function(
                      a,
                    ) {
                      g[a.nodeName] &&
                        ((a = i(a, !1)),
                        d ? f && f.appendChild(a) : (d = f = a),
                        (f = a))
                    }),
                    f &&
                      (f.innerHTML = c.ie
          ...
          return (
            ...
            0 === L.select('tr', g).length
              ...
              : (e(L.select('thead,tbody,tfoot', g), function(a) {
                ...
                void (
                  H &&
                  ((a = F[Math.min(F.length - 1, H.y)]),
                  a &&
                    (K.select(a[Math.min(a.length - 1, H.x)].elm, !0),
                    K.collapse(!0)))
                ))
          )
        }
          ...
          e(F, function(a, b) {
            e(a, function(a, c) {
              ...
              if (
                ...
                for (
                  k(a, 'rowSpan', 1), k(a, 'colSpan', 1), g = 0;
                  e - 1 > g;
                  g++
                )
                  L.insertAfter(o(a), a)
              ...
              for (o = g; m >= o; o++)
                F[q] &&
                  ...
                  b != s &&
                    ...
                    u.length &&
                      ((u = a.grep(s.childNodes)),
                      (v = 0),
                      e(u, function(a) {
                        'BR' == a.nodeName &&
                          L.getAttrib(a, 'data-mce-bogus') &&
                          v++ < u.length - 1 &&
                          s.removeChild(a)
                      })),
                    L.remove(b)))
              ...
              if (F[c][h] && ((f = F[c][h].elm), f != g)) {
                if (a) {
                  if (
                    c > 0 &&
                    F[c - 1][h] &&
                    ((p = F[c - 1][h].elm), (q = d(p, 'rowSpan')), q > 1)
                  ) {
                    k(p, 'rowSpan', q + 1)
                    continue
                  }
                ...
                ;(n = o(f)),
                  k(n, 'colSpan', f.colSpan),
                  m.appendChild(n),
                  (g = f)
              }
            m.hasChildNodes() &&
              (a ? j.parentNode.insertBefore(m, j) : L.insertAfter(m, j))
          }
        }
        function u(a) {
          var b, c
            ...
            e(F, function(e, f) {
              ...
              e[b] &&
                ...
                g != c &&
                  ...
                  1 == i
                    ? a
                      ? (g.parentNode.insertBefore(o(g), g), q(b, f, h - 1, i))
                      : (L.insertAfter(o(g), g), q(b, f, h - 1, i))
                    : k(g, 'colSpan', g.colSpan + 1),
                  (c = g)))
            })
        }
        function v() {
              ...
              l(c) &&
                ...
                (e(F, function(a) {
                  var b,
                    c = a[f].elm
                  ;(b = d(c, 'colSpan')),
                    b > 1 ? k(c, 'colSpan', b - 1) : L.remove(c)
                }),
                b.push(f))
            })
          }),
            ...
            e(a.cells, function(a) {
              ...
              e(F[b.y], function(a) {
                ...
                ;(a = a.elm),
                  a != c &&
                    ((b = d(a, 'rowSpan')),
                    1 >= b ? L.remove(a) : k(a, 'rowSpan', b - 1),
                    (c = a))
              })
          }
          var b
        ...
        function z(a, b) {
          ...
          a &&
            ...
            L.removeClass(
              L.select('td.mce-item-selected,th.mce-item-selected'),
              'mce-item-selected',
            ))
        }
        function A(a) {
        ...
        var F,
          ...
          K = f.selection,
          L = K.dom
        ;(g = g || L.getParent(K.getStart(), 'table')),
          h(),
          (J = L.getParent(K.getStart(), 'th,td')),
          J && ((H = A(J)), (I = C()), (J = j(H.x, H.y))),
          a.extend(this, {
            deleteTable: n,
            split: r,
            merge: s,
    ...
    d(
      ...
      ['tinymce/util/VK', 'tinymce/Env', 'tinymce/util/Tools'],
      function(a, b, c) {
        function d(a, b) {
          return parseInt(a.getAttribute(b) || 1, 10)
        }
          ...
          function f() {
            function b(b) {
              ...
              function k(a, b) {
                ...
                return d && 'BR' === d.nodeName
                  ? c.dom.getParent(d, 'td,th')
                  : d
              }
              function l(a) {
              ...
              function s(a, b) {
                return (
                  c.dom.getParent(a, 'TABLE') === c.dom.getParent(b, 'TABLE')
                )
              }
              var t = b.keyCode
              if (m() && n(c)) {
          ...
          function g() {
            ...
            c.on('KeyDown', function(b) {
              ...
              ;(37 == b.keyCode || 38 == b.keyCode) &&
                ((d = c.selection.getRng()),
                (e = f.getParent(d.startContainer, 'table')),
                e &&
                  c.getBody().firstChild == e &&
                  a(d, e) &&
                  ((d = f.createRng()),
                  d.setStartBefore(e),
                  d.setEndBefore(e),
              ...
              a &&
                ...
                (c.settings.forced_root_block
                  ? c.dom.add(
                      c.getBody(),
                      c.settings.forced_root_block,
                      c.settings.forced_root_block_attrs,
                      b.ie && b.ie < 11
                        ? '&nbsp;'
                        : '<br data-mce-bogus="1" />',
                    )
                  : c.dom.add(c.getBody(), 'br', { 'data-mce-bogus': '1' }))
            }),
          ...
          function i() {
            ...
            function b() {
              ...
              if (a(c, b, d, e)) {
                ...
                3 == f.nodeType &&
                  (b.setEnd(f, f.data.length), c.selection.setRng(b))
              }
            }
            ...
            j(
              ...
              function(b, c) {
                e.addCommand(c, function() {
                  var c = new a(e)
                  c &&
                    (b(c), e.execCommand('mceRepaint'), p.cellSelection.clear())
                })
              },
            ),
            j(
