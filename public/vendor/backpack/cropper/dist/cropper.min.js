...
!(function(t) {
  ...
  function l(e, s) {
    ...
    return (
      ...
      (n.width = C),
      (n.height = b),
      x && ((p = -d / 2), (l = -g / 2), r.save(), r.translate(a, o)),
      v && r.scale(f, m),
      w && r.rotate((u * Math.PI) / 180),
      r.drawImage(e, $t(p), $t(l), $t(d), $t(g)),
      x && r.restore(),
      n
    )
  }
    ...
    if (
      (n &&
        ...
        'Exif' === g(l, e, 4) &&
          ...
          (o = 18761 === h),
          (o || 19789 === h) &&
            42 === l.getUint16(s + 2, o) &&
            ((a = l.getUint32(s + 4, o)), a >= 8 && (r = s + a)))),
      r)
    )
      for (d = l.getUint16(r, o), c = 0; d > c; c++)
  ...
  ;(v.prototype = {
    ...
    load: function(i) {
      ...
      if (i && (n.one(A, a.build), !this.trigger(A).isDefaultPrevented())) {
        if (((this.url = i), (this.image = {}), !a.checkOrientation || !B))
          return this.clone()
        if (((e = t.proxy(this.read, this)), V.test(i)))
          return J.test(i) ? e(f(i)) : this.clone()
        ;(s = new XMLHttpRequest()),
          (s.onerror = s.onabort = t.proxy(function() {
            this.clone()
          }, this)),
          (s.onload = function() {
            e(this.response)
          }),
          a.checkCrossOrigin && o(i) && n.prop('crossOrigin') && (i = h(i)),
          s.open('get', i),
    ...
    clone: function() {
      ...
      s.checkCrossOrigin &&
        ...
        this.isImg
          ? a[0].complete
            ? this.start()
            : a.one(I, t.proxy(this.start, this))
          : e
              .one(I, t.proxy(this.start, this))
              .one(F, t.proxy(this.stop, this))
              .addClass(X)
              .insertAfter(a)
    },
    start: function() {
      var i = this.$element,
        e = this.$clone
      this.isImg || (e.off(F, this.stop), (i = e)),
        r(
          i[0],
    ...
    build: function() {
      ...
      this.isLoaded &&
        ...
        o.addClass(Y).after(i),
        this.isImg || h.removeClass(X),
        this.initPreview(),
        this.bind(),
        (a.aspectRatio = xt(0, a.aspectRatio) || NaN),
        (a.viewMode = xt(0, wt(3, Dt(a.viewMode))) || 0),
        a.autoCrop
          ? ((this.isCropped = !0), a.modal && this.$dragBox.addClass(T))
          : e.addClass(Y),
        a.guides || e.find('.cropper-dashed').addClass(Y),
        a.center || e.find('.cropper-center').addClass(Y),
        a.cropBoxMovable && s.addClass(M).data(it, ct),
        a.highlight || s.addClass(k),
        a.background && i.addClass(R),
        a.cropBoxResizable ||
          e.find('.cropper-line, .cropper-point').addClass(Y),
    ...
    limitCanvas: function(t, i) {
      var e,
        ...
        u = this.isCropped && g
      t &&
        ((e = vt(h.minCanvasWidth) || 0),
        (s = vt(h.minCanvasHeight) || 0),
        n &&
          (n > 1
            ? ((e = xt(e, p)),
              (s = xt(s, c)),
        ...
        i &&
          (n
            ? ((a = p - l.width),
              ...
              u &&
                this.isLimited &&
                ((l.minLeft = wt(g.left, g.left + g.width - l.width)),
                (l.minTop = wt(g.top, g.top + g.height - l.height)),
                (l.maxLeft = g.left),
                (l.maxTop = g.top),
                2 === n &&
                  (l.width >= p &&
                    ((l.minLeft = wt(0, a)), (l.maxLeft = xt(0, a))),
                  l.height >= c &&
                    ((l.minTop = wt(0, o)), (l.maxTop = xt(0, o))))))
            : ((l.minLeft = -l.width),
              (l.minTop = -l.height),
              (l.maxLeft = p),
              (l.maxTop = c)))
    ...
    renderCanvas: function(t) {
      ...
      this.isRotated &&
        ((this.isRotated = !1),
        (e = c({ width: a.width, height: a.height, degree: o })),
        (i = e.width / e.height),
        i !== s.aspectRatio &&
        ...
        (s.height > s.maxHeight || s.height < s.minHeight) &&
          (s.top = s.oldTop),
        (s.width = wt(xt(s.width, s.minWidth), s.maxWidth)),
        (s.height = wt(xt(s.height, s.minHeight), s.maxHeight)),
        this.limitCanvas(!1, !0),
        (s.oldLeft = s.left = wt(xt(s.left, s.minLeft), s.maxLeft)),
        (s.oldTop = s.top = wt(xt(s.top, s.minTop), s.maxTop)),
        this.$canvas.css({
          width: s.width,
          height: s.height,
          left: s.left,
    ...
    initCropBox: function() {
      ...
      s &&
        ...
        (o.width = wt(xt(o.width, o.minWidth), o.maxWidth)),
        (o.height = wt(xt(o.height, o.minHeight), o.maxHeight)),
        (o.width = xt(o.minWidth, o.width * a)),
        (o.height = xt(o.minHeight, o.height * a)),
    ...
    limitCropBox: function(t, i) {
      var e,
        ...
        g = this.isLimited
      t &&
        ((e = vt(h.minCropBoxWidth) || 0),
        (s = vt(h.minCropBoxHeight) || 0),
        (e = wt(e, p)),
        (s = wt(s, c)),
        (a = wt(p, g ? l.width : p)),
        (o = wt(c, g ? l.height : c)),
        ...
        i &&
          (g
            ? ((d.minLeft = xt(0, l.left)),
              (d.minTop = xt(0, l.top)),
              (d.maxLeft = wt(p, l.left + l.width) - d.width),
              (d.maxTop = wt(c, l.top + l.height) - d.height))
            : ((d.minLeft = 0),
              (d.minTop = 0),
              (d.maxLeft = p - d.width),
              (d.maxTop = c - d.height)))
    ...
    renderCropBox: function() {
      ...
      ;(a.width > a.maxWidth || a.width < a.minWidth) && (a.left = a.oldLeft),
        (a.height > a.maxHeight || a.height < a.minHeight) &&
          (a.top = a.oldTop),
        (a.width = wt(xt(a.width, a.minWidth), a.maxWidth)),
        (a.height = wt(xt(a.height, a.minHeight), a.maxHeight)),
        this.limitCropBox(!1, !0),
        (a.oldLeft = a.left = wt(xt(a.left, a.minLeft), a.maxLeft)),
        (a.oldTop = a.top = wt(xt(a.top, a.minTop), a.maxTop)),
        t.movable &&
          t.cropBoxMovable &&
          this.$face.data(it, a.width === e && a.height === s ? dt : ct),
        this.$cropBox.css({
          width: a.width,
          height: a.height,
          left: a.left,
    ...
    initPreview: function() {
      ...
      ;(this.$preview = t(this.options.preview)),
        (this.$clone2 = i = t('<img' + e + ' src="' + s + '">')),
        this.$viewBox.html(i),
        this.$preview.each(function() {
          var i = t(this)
          i.data(tt, { width: i.width(), height: i.height(), html: i.html() }),
            i.html(
              '<img' +
                e +
                ' src="' +
    ...
    resetPreview: function() {
      this.$preview.each(function() {
        var i = t(this),
          e = i.data(tt)
        i.css({ width: e.width, height: e.height })
          .html(e.html)
          .removeData(tt)
      })
    },
    ...
    bind: function() {
      var i = this.options,
        e = this.$element,
        s = this.$cropper
      t.isFunction(i.cropstart) && e.on(N, i.cropstart),
        t.isFunction(i.cropmove) && e.on(_, i.cropmove),
        t.isFunction(i.cropend) && e.on(q, i.cropend),
        t.isFunction(i.crop) && e.on(K, i.crop),
        t.isFunction(i.zoom) && e.on(Z, i.zoom),
        s.on(z, t.proxy(this.cropStart, this)),
        i.zoomable && i.zoomOnWheel && s.on(E, t.proxy(this.wheel, this)),
        i.toggleDragModeOnDblclick && s.on(U, t.proxy(this.dblclick, this)),
        x
    ...
    unbind: function() {
      var i = this.options,
        e = this.$element,
        s = this.$cropper
      t.isFunction(i.cropstart) && e.off(N, i.cropstart),
        t.isFunction(i.cropmove) && e.off(_, i.cropmove),
        t.isFunction(i.cropend) && e.off(q, i.cropend),
        t.isFunction(i.crop) && e.off(K, i.crop),
        t.isFunction(i.zoom) && e.off(Z, i.zoom),
        s.off(z, this.cropStart),
        i.zoomable && i.zoomOnWheel && s.off(E, this.wheel),
        i.toggleDragModeOnDblclick && s.off(U, this.dblclick),
        x.off(O, this._cropMove).off(P, this._cropEnd),
        i.responsive && w.off(j, this._resize)
    },
    resize: function() {
      var i,
        e,
    ...
    dblclick: function() {
      this.isDisabled ||
        (this.$dragBox.hasClass(W)
          ? this.setDragMode(dt)
          : this.setDragMode(lt))
    },
    wheel: function(i) {
      var e = i.originalEvent || i,
        s = vt(this.options.wheelZoomRatio) || 0.1,
        a = 1
      this.isDisabled ||
        (i.preventDefault(),
        this.wheeling ||
      ...
      if (!this.isDisabled) {
        ...
        if (((s = s || t(n.target).data(it)), Q.test(s))) {
          ...
          i.preventDefault(),
            ...
            s === lt && ((this.cropping = !0), this.$dragBox.addClass(T))
        }
      }
    },
    cropMove: function(t) {
      ...
      if (!this.isDisabled) {
        ...
        if (h) {
          ...
          t.preventDefault(),
            ...
            this.change(o.shiftKey, h === gt ? t : null)
        }
      }
    },
    cropEnd: function(t) {
      ...
      this.isDisabled ||
        (e &&
          ...
          this.cropping &&
            ((this.cropping = !1),
            this.$dragBox.toggleClass(T, this.isCropped && this.options.modal)),
          (this.action = ''),
          this.trigger(q, { originalEvent: i, action: e })))
    },
    change: function(t, i) {
      var e,
        s,
      ...
      switch (
        ...
        this.isLimited &&
          ((m = p.minLeft),
          (v = p.minTop),
          (w = m + wt(n.width, r.left + r.width)),
          (x = v + wt(n.height, r.top + r.height))),
        ...
        case lt:
          ...
          ;(e = this.$cropper.offset()),
            ...
            s.x > 0
              ? (h = s.y > 0 ? ht : rt)
              : s.x < 0 && ((d -= c), (h = s.y > 0 ? nt : pt)),
            s.y < 0 && (g -= l),
            this.isCropped ||
              (this.$cropBox.removeClass(Y),
              (this.isCropped = !0),
              this.isLimited && this.limitCropBox(!0, !0))
      }
      C &&
        ((p.width = c),
        (p.height = l),
    ...
    crop: function() {
      this.isBuilt &&
        ...
        (this.isCropped ||
          ((this.isCropped = !0),
          this.limitCropBox(!0, !0),
          this.options.modal && this.$dragBox.addClass(T),
          this.$cropBox.removeClass(Y)),
    ...
    clear: function() {
      this.isCropped &&
        ...
        this.limitCanvas(!0, !0),
        this.renderCanvas(),
        this.$dragBox.removeClass(T),
        this.$cropBox.addClass(Y))
    },
    replace: function(t, i) {
      !this.isDisabled &&
        t &&
        (this.isImg && this.$element.attr('src', t),
        i
          ? ((this.url = t),
    ...
    zoomTo: function(t, i) {
      var e,
        ...
        g = r.naturalHeight
      if (
        ((t = vt(t)), t >= 0 && this.isBuilt && !this.isDisabled && n.zoomable)
      ) {
        if (
          ((s = l * t),
          (a = g * t),
        ...
        e
          ? ((o = this.$cropper.offset()),
            ...
            (r.top -= (a - c) * ((h.pageY - o.top - r.top) / c)))
          : ((r.left -= (s - p) / 2), (r.top -= (a - c) / 2)),
          (r.width = s),
          (r.height = a),
          this.renderCanvas(!0)
      }
      ...
      return this.isBuilt && ft
        ? this.isCropped
          ? (t.isPlainObject(i) || (i = {}),
            ...
            (d = c.getContext('2d')),
            i.fillColor &&
              ((d.fillStyle = i.fillColor), d.fillRect(0, 0, a, o)),
            d.drawImage.apply(
              d,
              function() {
                var t,
                ...
                return (
                  -e >= m || m > c
                    ? (m = t = a = h = 0)
                    : 0 >= m
                    ? ((a = -m), (m = 0), (t = h = wt(c, e + m)))
                    : c >= m && ((a = 0), (t = h = wt(e, c - m))),
                  0 >= t || -s >= v || v > d
                    ? (v = i = o = n = 0)
                    : 0 >= v
                    ? ((o = -v), (v = 0), (i = n = wt(d, s + v)))
                    : d >= v && ((o = 0), (i = n = wt(s, d - v))),
                  f.push($t(m), $t(v), $t(t), $t(i)),
                  r && ((a *= r), (o *= r), (h *= r), (n *= r)),
                  h > 0 && n > 0 && f.push($t(a), $t(o), $t(h), $t(n)),
                  f
                )
              }.call(this),
            ),
            c)
          : l(this.$clone[0], this.image)
        : void 0
    },
