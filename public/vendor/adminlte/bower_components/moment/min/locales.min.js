!(function(e, a) {
  ...
  function n(e, a, _, s) {
    ...
    switch (_) {
      ...
      case 'ss':
        return a || s ? d + (t(e) ? 'sekundy' : 'sekund') : d + 'sekundami'
        break
      case 'm':
        return a ? 'minuta' : s ? 'minutu' : 'minutou'
      case 'mm':
        return a || s ? d + (t(e) ? 'minuty' : 'minut') : d + 'minutami'
        break
      case 'h':
        return a ? 'hodina' : s ? 'hodinu' : 'hodinou'
      case 'hh':
        return a || s ? d + (t(e) ? 'hodiny' : 'hodin') : d + 'hodinami'
        break
      case 'd':
        return a || s ? 'den' : 'dnem'
      case 'dd':
        return a || s ? d + (t(e) ? 'dny' : 'dn\xed') : d + 'dny'
        break
      case 'M':
      ...
      case 'yy':
        return a || s ? d + (t(e) ? 'roky' : 'let') : d + 'lety'
        break
    }
  }
  function r(e, a, _, s) {
  ...
  function S(e, a, _) {
    ...
    switch (_) {
      case 'ss':
        return s + (v(e) ? 'sekundy' : 'sekund')
      case 'm':
        return a ? 'minuta' : 'minut\u0119'
      case 'mm':
        return s + (v(e) ? 'minuty' : 'minut')
      case 'h':
        return a ? 'godzina' : 'godzin\u0119'
      case 'hh':
        return s + (v(e) ? 'godziny' : 'godzin')
      case 'MM':
        return s + (v(e) ? 'miesi\u0105ce' : 'miesi\u0119cy')
      case 'yy':
        return s + (v(e) ? 'lata' : 'lat')
    }
  }
  function j(e, a, _) {
    var s = ' '
  ...
  function W(e, a, _, s) {
    ...
    switch (_) {
      ...
      case 'ss':
        return a || s ? d + (P(e) ? 'sekundy' : 'sek\xfand') : d + 'sekundami'
        break
      case 'm':
        return a ? 'min\xfata' : s ? 'min\xfatu' : 'min\xfatou'
      case 'mm':
        return a || s
          ? d + (P(e) ? 'min\xfaty' : 'min\xfat')
          : d + 'min\xfatami'
        break
      case 'h':
        return a ? 'hodina' : s ? 'hodinu' : 'hodinou'
      case 'hh':
        return a || s ? d + (P(e) ? 'hodiny' : 'hod\xedn') : d + 'hodinami'
        break
      case 'd':
        return a || s ? 'de\u0148' : 'd\u0148om'
      case 'dd':
        return a || s ? d + (P(e) ? 'dni' : 'dn\xed') : d + 'd\u0148ami'
        break
      case 'M':
        return a || s ? 'mesiac' : 'mesiacom'
      case 'MM':
        return a || s ? d + (P(e) ? 'mesiace' : 'mesiacov') : d + 'mesiacmi'
        break
      case 'y':
        return a || s ? 'rok' : 'rokom'
      case 'yy':
        return a || s ? d + (P(e) ? 'roky' : 'rokov') : d + 'rokmi'
        break
    }
  }
  function A(e, a, _, s) {
  ...
  e.defineLocale('az', {
    ...
    ordinal: function(e) {
      ...
      var a = e % 10
      return e + (Z[a] || Z[(e % 100) - a] || Z[e >= 100 ? 100 : null])
    },
    week: { dow: 1, doy: 7 },
  }),
    e.defineLocale('be', {
  ...
  var se = 'leden_\xfanor_b\u0159ezen_duben_kv\u011bten_\u010derven_\u010dervenec_srpen_z\xe1\u0159\xed_\u0159\xedjen_listopad_prosinec'.split(
      '_',
    ),
    de = 'led_\xfano_b\u0159e_dub_kv\u011b_\u010dvn_\u010dvc_srp_z\xe1\u0159_\u0159\xedj_lis_pro'.split(
      '_',
    )
  e.defineLocale('cs', {
    months: se,
  ...
  var re = 'ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.'.split(
      '_',
    ),
    ...
    oe = /^(enero|febrero|marzo|abril|mayo|junio|julio|agosto|septiembre|octubre|noviembre|diciembre|ene\.?|feb\.?|mar\.?|abr\.?|may\.?|jun\.?|jul\.?|ago\.?|sep\.?|oct\.?|nov\.?|dic\.?)/i
  e.defineLocale('es-do', {
    months: 'enero_febrero_marzo_abril_mayo_junio_julio_agosto_septiembre_octubre_noviembre_diciembre'.split(
      '_',
    ),
    monthsShort: function(e, a) {
      return e ? (/-MMM-/.test(a) ? ie[e.month()] : re[e.month()]) : re
    },
    monthsRegex: oe,
    monthsShortRegex: oe,
  ...
  var ue = 'ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.'.split(
      '_',
    ),
  ...
  e.defineLocale('es-us', {
    ...
    monthsShort: function(e, a) {
      return e ? (/-MMM-/.test(a) ? le[e.month()] : ue[e.month()]) : ue
    },
    monthsParseExact: !0,
    weekdays: 'domingo_lunes_martes_mi\xe9rcoles_jueves_viernes_s\xe1bado'.split(
      '_',
  ...
  var Me = 'ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.'.split(
      '_',
    ),
    Le = 'ene_feb_mar_abr_may_jun_jul_ago_sep_oct_nov_dic'.split('_'),
    Ye = [
    ...
    he = /^(enero|febrero|marzo|abril|mayo|junio|julio|agosto|septiembre|octubre|noviembre|diciembre|ene\.?|feb\.?|mar\.?|abr\.?|may\.?|jun\.?|jul\.?|ago\.?|sep\.?|oct\.?|nov\.?|dic\.?)/i
  e.defineLocale('es', {
    months: 'enero_febrero_marzo_abril_mayo_junio_julio_agosto_septiembre_octubre_noviembre_diciembre'.split(
      '_',
    ),
  ...
  var ke = 'nolla yksi kaksi kolme nelj\xe4 viisi kuusi seitsem\xe4n kahdeksan yhdeks\xe4n'.split(
      ' ',
    ),
    pe = [
      'nolla',
  ...
  var De = 'jan._feb._mrt._apr._mai_jun._jul._aug._sep._okt._nov._des.'.split(
      '_',
    ),
  ...
  e.defineLocale('kk', {
    ...
    ordinal: function(e) {
      return e + (ve[e] || ve[e % 10] || ve[e >= 100 ? 100 : null])
    },
    week: { dow: 1, doy: 7 },
  }),
    e.defineLocale('km', {
  ...
  e.defineLocale('ky', {
    ...
    e.defineLocale('lb', {
      ...
      relativeTime: {
        future: function(e) {
          return k(e.substr(0, e.indexOf(' '))) ? 'a ' + e : 'an ' + e
        },
        past: function(e) {
          return k(e.substr(0, e.indexOf(' '))) ? 'viru ' + e : 'virun ' + e
        },
        s: 'e puer Sekonnen',
        ss: '%d Sekonnen',
        m: c,
    ...
    translate: function(e, a, _) {
      ...
      return 1 === _.length
        ? a
          ? s[0]
          : s[1]
        : e + ' ' + Ae.correctGrammaticalCase(e, s)
    },
  }
  e.defineLocale('me', {
  ...
  var Ne = 'jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.'.split(
      '_',
    ),
    Re = 'jan_feb_mrt_apr_mei_jun_jul_aug_sep_okt_nov_dec'.split('_'),
    Ke = [
      /^jan/i,
      /^feb/i,
      /^maart|mrt.?$/i,
  ...
  var Ge = 'jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.'.split(
      '_',
    ),
    ...
    $e = /^(januari|februari|maart|april|mei|april|ju[nl]i|augustus|september|oktober|november|december|jan\.?|feb\.?|mrt\.?|apr\.?|ju[nl]\.?|aug\.?|sep\.?|okt\.?|nov\.?|dec\.?)/i
  e.defineLocale('nl', {
    months: 'januari_februari_maart_april_mei_juni_juli_augustus_september_oktober_november_december'.split(
      '_',
    ),
    monthsShort: function(e, a) {
      return e ? (/-MMM-/.test(a) ? Be[e.month()] : Ge[e.month()]) : Ge
    },
    monthsRegex: $e,
    monthsShortRegex: $e,
    monthsStrictRegex: /^(januari|februari|maart|mei|ju[nl]i|april|augustus|september|oktober|november|december)/i,
  ...
  var Ve = 'stycze\u0144_luty_marzec_kwiecie\u0144_maj_czerwiec_lipiec_sierpie\u0144_wrzesie\u0144_pa\u017adziernik_listopad_grudzie\u0144'.split(
      '_',
    ),
    Ze = 'stycznia_lutego_marca_kwietnia_maja_czerwca_lipca_sierpnia_wrze\u015bnia_pa\u017adziernika_listopada_grudnia'.split(
      '_',
    )
  e.defineLocale('pl', {
    months: function(e, a) {
  ...
  var _a = 'janu\xe1r_febru\xe1r_marec_apr\xedl_m\xe1j_j\xfan_j\xfal_august_september_okt\xf3ber_november_december'.split(
      '_',
    ),
    sa = 'jan_feb_mar_apr_m\xe1j_j\xfan_j\xfal_aug_sep_okt_nov_dec'.split('_')
  e.defineLocale('sk', {
    months: _a,
    monthsShort: sa,
    ...
    translate: function(e, a, _) {
      ...
      return 1 === _.length
        ? a
          ? s[0]
          : s[1]
        : e + ' ' + da.correctGrammaticalCase(e, s)
    },
  }
    ...
    translate: function(e, a, _) {
      ...
      return 1 === _.length
        ? a
          ? s[0]
          : s[1]
        : e + ' ' + ta.correctGrammaticalCase(e, s)
    },
  }
  e.defineLocale('sr', {
    months: 'januar_februar_mart_april_maj_jun_jul_avgust_septembar_oktobar_novembar_decembar'.split(
  ...
  var ia = 'pagh_wa\u2019_cha\u2019_wej_loS_vagh_jav_Soch_chorgh_Hut'.split('_')
  e.defineLocale('tlh', {
  ...
  e.defineLocale('tr', {
    ...
    ordinal: function(e) {
      if (0 === e) return e + "'\u0131nc\u0131"
      var a = e % 10
      return e + (ma[a] || ma[(e % 100) - a] || ma[e >= 100 ? 100 : null])
    },
    week: { dow: 1, doy: 7 },
  }),
    e.defineLocale('tzl', {
