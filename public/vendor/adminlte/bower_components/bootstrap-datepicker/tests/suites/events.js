module('Events on initialization', {
  setup: function() {
    this.input = $('<input type="text" value="31-03-2011">').appendTo(
      '#qunit-fixture',
    )
  },
})
...
test('Navigating forward/backward from month view triggers changeMonth', function() {
  ...
  target.click()
  ok(
    this.picker.find('.datepicker-days').is(':visible'),
...
test('Clear button: triggers change and changeDate events', function() {
  ...
  ok(
    this.picker.find('.datepicker-days tfoot .clear').is(':visible'),
