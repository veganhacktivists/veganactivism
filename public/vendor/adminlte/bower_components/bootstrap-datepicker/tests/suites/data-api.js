...
test('DATA-API: data-provide="datepicker" on input; focus', function() {
  var input = $('<input data-provide="datepicker" />').appendTo(
    '#qunit-fixture',
  )
  input.focus()
...
test('DATA-API: data-provide="datepicker" on component', function() {
  ...
  ok(
    comp.data('datepicker'),
    'append component initialized by "focus" event on input',
  )
  comp.remove()
  ...
  ok(
    comp.data('datepicker'),
    'append component initialized by "click" event on input',
  )
  comp.remove()
  ...
  ok(
    comp.data('datepicker'),
    'append component initialized by "focus" event on add-on',
  )
  comp.remove()
  ...
  ok(
    comp.data('datepicker'),
    'append component initialized by "click" event on add-on',
  )
  comp.remove()
  ...
  ok(
    comp.data('datepicker'),
    'prepend component initialized by "focus" event on input',
  )
  comp.remove()
  ...
  ok(
    comp.data('datepicker'),
    'prepend component initialized by "click" event on input',
  )
  comp.remove()
  ...
  ok(
    comp.data('datepicker'),
    'prepend component initialized by "focus" event on add-on',
  )
  comp.remove()
  ...
  ok(
    comp.data('datepicker'),
    'prepend component initialized by "click" event on add-on',
  )
  comp.remove()
})
...
test('DATA-API: data-provide="datepicker" on rangepicker', function() {
  ...
  ok(
    comp.data('datepicker'),
    'range initialized by "focus" event on first input',
  )
  comp.remove()
  ...
  ok(
    comp.data('datepicker'),
    'range initialized by "click" event on first input',
  )
  comp.remove()
  ...
  ok(
    comp.data('datepicker'),
    'range initialized by "focus" event on last input',
  )
  comp.remove()
  ...
  ok(
    comp.data('datepicker'),
    'range initialized by "click" event on last input',
  )
  comp.remove()
})
