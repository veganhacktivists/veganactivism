...
;(function() {
  CKEDITOR.plugins.add('placeholder', {
    ...
    lang:
      'af,ar,az,bg,ca,cs,cy,da,de,de-ch,el,en,en-au,en-gb,eo,es,es-mx,et,eu,fa,fi,fr,fr-ca,gl,he,hr,hu,id,it,ja,km,ko,ku,lv,nb,nl,no,oc,pl,pt,pt-br,ro,ru,si,sk,sl,sq,sv,th,tr,tt,ug,uk,vi,zh,zh-cn',
    icons: 'placeholder',
    hidpi: !0,
    onLoad: function() {
