...
;(function() {
  CKEDITOR.plugins.add('mathjax', {
    lang:
      'af,ar,az,bg,ca,cs,cy,da,de,de-ch,el,en,en-au,en-gb,eo,es,es-mx,eu,fa,fi,fr,gl,he,hr,hu,id,it,ja,km,ko,ku,lt,nb,nl,no,oc,pl,pt,pt-br,ro,ru,sk,sl,sq,sv,tr,tt,ug,uk,vi,zh,zh-cn',
  ...
  CKEDITOR.plugins.mathjax.copyStyles = function(b, c) {
    for (
      var a = 'color font-family font-style font-weight font-variant font-size'.split(
          ' ',
        ),
        e = 0;
      e < a.length;
