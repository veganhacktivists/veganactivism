    ...
    (b.prototype = {
      ...
      toAlias: function(a, b, c, d) {
        var e,
          ...
          g =
            'alias' === this.origFormat ? f : this.toString(this.origFormat, !1)
          ...
          a.each(this.stringParsers, function(a, h) {
            ...
            return (
              ...
              !c ||
                ...
                (f = d.match(/hsla?/)
                  ? e.RGBtoHSB.apply(e, e.HSLtoRGB.apply(e, c))
        ...
        switch (a) {
          ...
          case 'alias':
            return (
              (d = this.toAlias()),
              d === !1
                ? this.toString(this.getValidFallbackFormat())
                : c && !(d in b.webColors) && d in this.predefinedColors
                ? this.predefinedColors[d]
                : d
            )
          default:
            return d
  ...
  ;(d.Color = b),
    (d.prototype = {
      ...
      updateData: function(a) {
        return (
          (a = a || this.color.toString(this.format, !1)),
      ...
      updateInput: function(a) {
        return (
          (a = a || this.color.toString(this.format, !1)),
          this.input !== !1 &&
            (this.input.prop('value', a), this.input.trigger('change')),
          a
        )
      },
        ...
        if (0 !== c.length)
          return (
            ...
            this.picker
              ...
              .css('backgroundColor', this.color.toString(this.format, !0)),
            a
          )
      },
      updateComponent: function(a) {
        var b
        if (
          ((b = 'undefined' != typeof a ? this.createColor(a) : this.color),
          this.component !== !1)
        ) {
          var c = this.component.find('i').eq(0)
          c.length > 0
            ? c.css({ backgroundColor: b.toString(this.format, !0) })
            : this.component.css({
