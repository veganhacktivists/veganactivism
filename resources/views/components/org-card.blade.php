<div class="col-md-6 col-lg-6">
  <div class="card my-3 border-0">
    ...
    <div class="card-body">
      ...
      <div class="my-2">
        <a href={{ $organization->website }} class="btn btn-dark py-1"><i class="fas fa-info-circle mr-2"></i>Learn More</a>
        <a href={{ $organization->website }} class="btn btn-danger ml-3 py-1"><i class="fas fa-link mr-2"></i>Visit Website</a>
      </div>
